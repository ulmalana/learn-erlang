...
-export([init/1, handle_event/3, handle_sync_event/4, handle_info/3, terminate/3,
         code_change/4, idle/2, idle/3, idle_wait/2, idle_wait/3, negotiate/2,
...
do_commit(OtherPid) ->
    gen_fsm:sync_send_commit(OtherPid, do_commit).
...
idle({ask_negotiate, OtherPid}, S=#state{}) ->
    ...
    notice(S, "~p asked for a trade nego", [OtherPid]),
...
wait(are_you_ready, S=#state{}) ->
    ...
    notice(S, "asked if ready, and i am. waiting for reply", []),
    {next_state, wait, S};
